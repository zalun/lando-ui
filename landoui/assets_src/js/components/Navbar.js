...
$.fn.landoNavbar = function() {
  return this.each(function() {
    ...
    let $errorPageShowModal = $('.Error-ShowAPIToken');
    ...
    let isSetPhabAPIToken = !!$navbar.find('.phabricator-api-token-set').length;

    function resetSettingsFormErrors() {
      $settingsFormErrors.each(function() {
        $(this).empty();
      });
    }
    ...
    function setAPITokenPlaceholder() {
      ...
      if (!isSetPhabAPIToken) {
        ...
        $phabAPITokenInput.prop('placeholder', 'hidden');
      }
    }
